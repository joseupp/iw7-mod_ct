...
f0_local0 = function ( f1_arg0, f1_arg1, f1_arg2 )
	...
	f1_arg0.GameSetup:addEventHandler( "gain_focus", function ( f7_arg0, f7_arg1 )
		local f4_local0 = LUI.FlowManager.GetScopedData( f1_arg0 )
		f4_local0.mapGridIndex = 0
	end )
...
function LobbyMissionVerticalLayout( menu, controller )
	...
	GameSetup:SetAnchorsAndPosition( 0, 1, 0, 1, 0, _1080p * 500, _1080p * 120, _1080p * 150 )
	...
	GameSetup:addEventHandler( "button_action", function ( f17_arg0, f17_arg1 )
		--Engine.Exec( "xstartlobby" )
