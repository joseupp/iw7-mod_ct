...
function GameSetup2( menu, controller )
	...
	local GameSetupButtons2 = nil
	
	GameSetupButtons2 = MenuBuilder.BuildRegisteredType( "GameSetupButtons2", {
		controllerIndex = f2_local1
	} )
	GameSetupButtons2.id = "GameSetupButtons2"
	GameSetupButtons2:SetAnchorsAndPosition( 0, 1, 0, 1, _1080p * 130, _1080p * 630, _1080p * 216, _1080p * 406 )
	self:addElement( GameSetupButtons2 )
	self.GameSetupButtons2 = GameSetupButtons2
...
MenuBuilder.registerType( "GameSetup2", GameSetup2 )
LockTable( _M )
