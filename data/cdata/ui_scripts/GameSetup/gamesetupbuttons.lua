...
f0_local1 = function ( f2_arg0, f2_arg1, f2_arg2 )
	...
	MatchRules.SetUsingMatchRulesData( 0 )
	...
	local f2_local0 = Engine.GetDvarString( "ui_mapname" )
...
function GameSetupButtons2( menu, controller )
	local self = LUI.UIVerticalList.new()
	self:SetAnchorsAndPosition( 0, 1, 0, 1, 0, 600 * _1080p, 0, 190 * _1080p )
	self.id = "GameSetupButtons2"
	...
	ModesButton:addEventHandler( "button_action", function ( f5_arg0, f5_arg1 )
		ACTIONS.OpenMenu( "PlaylistMenu", true, f5_arg1.controller or f3_local1 )
	end )
	...
	BotSetup:addEventHandler( "button_action", function ( f7_arg0, f7_arg1 )
		ACTIONS.OpenMenu( "GameSetupBots2", true, f7_arg1.controller or f3_local1 )
	end )
	f0_local1( self, f3_local1, controller )
	return self
end

MenuBuilder.registerType( "GameSetupButtons2", GameSetupButtons2 )
LockTable( _M )
