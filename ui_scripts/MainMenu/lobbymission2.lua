...
function PostLoadFunc( f12_arg0, f12_arg1, f12_arg2 )
	...
	f12_arg0.MenuTitle:SubscribeToModel( DataSources.frontEnd.lobby.gameType:GetModel( f12_arg1 ), function ()
		...
		if Engine.GetDvarBool("xblive_privatematch") then
			f12_arg0.MenuTitle.MenuTitle:setText( ToUpperCase( DataSources.frontEnd.lobby.gameTypeName:GetValue( f12_arg0 ) ), 0 )
		else 
			f12_arg0.MenuTitle.MenuTitle:setText( ToUpperCase( Playlist.GetPlaylistName( Engine.GetDvarInt( "playlist" ) ) ), 0 )
		end
		f12_arg0.MenuTitle.MenuBreadcrumbs:setText( ToUpperCase( Engine.Localize( "LUA_MENU_BREADCRUMB_2_ITEMS", "LUA_MENU_LOCAL_PLAY_CAPS", "MENU_MULTIPLAYER" ) ), 0 )
